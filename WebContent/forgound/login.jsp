					...
					<div class="main">
						...
						<div class="main1">
							...
							<form method="post" action="<c:url value='/LoginServlet'/>">
								<table>
									<tr>
										<td>登录账号 <input type="text" name="userName" value="${user.userName }"/></td>
									</tr>

									<tr>
										<td>登录密码 <input type="password" name="userPwd" value="${user.userPwd }" /></td>
									</tr>

									<tr>
										<td align="center">
											<input type="submit" name="login" id="login" class="loginbutton" value=""/>
											<a href="<c:url value='/forgound/regist.jsp'/>" >
											<div class="registerbutton" id="a3"></div>
											</a>
										</td>
									</tr>
									<tr>
							...
							<table>
								...
								<tr>
									<td><img src="<c:url value='/forgound/img/cateitems.gif'/>">如果您忘记了密码，
										<a href="LoginUpdate.jsp" id="a2" action="<c:url value='/forgound/login.jsp'/>">点这里重设一个密码</a>
									</td>
								</tr>
