	...
	<body>
		<center>
			...
			<div id="all">
				...
				<!-- 主体内容开始 -->
				<div class="middle">
					<h2 id="titile1" align="center">${mess.title}</h2>
					<h2 id="time" align="center">${mess.messdate }</h2>
			<table align="center" width="800px">
			<tr>
				<td id="text1">&nbsp;&nbsp;${mess.detail }</td>
			</tr>
			<tr>
				<td></td>
			...
			<center><h3><a href="<c:url value='/index.jsp'/>" >返回</a></h3>
		</center>
		</div>
		<!-- 主体内容结束 -->
